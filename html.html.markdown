...
**NOTE :**  You can test the different tags and elements as you progress through the tutorial on sites like [codepen](http://codepen.io/pen/) in order to see their effects, understand how they work and familiarise yourself with the language.
...
<!-- A header (it must be closed with </head>). -->
<!-- The header contains some description and additional information which are not displays; this is metadata. -->
...
<body>
	...
	<!-- If we wish to have a numbered list instead we use <ol> giving 1. for the first element, 2. for the second, etc. -->
		<li>This is an item in a non-enumerated list (bullet list)</li>
		<li>This is another item</li>
		<li>And this is the last item on the list</li>
	</ul>
...
<!-- And there we are, creating an HTML file is simple. -->
...
<!-- The source can be an URL or path of a file on your computer. -->
