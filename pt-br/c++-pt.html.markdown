...
// A função main() em C++ deve retornar um int, embora void main() seja aceita
...
public:
    ...
    // declaradas como _virtual_, a fim de ser substituídas em classes
    ...
    // (veja abaixo)
    // Destruidores devem ser virtual para permitir as classes de serem
    // derivadas desta.
    virtual ~Dog();
...
public:
    ...
    // A sintaxe a seguir é conhecida como uma lista de inicialização
