...
// Щоб додати власні загаловки, потрібно використовувати "подвійні лапки" 
// замість кутових:
//#include "my_header.h"
...
// argv - це масив масивів рядків, що містить самі аргументи
...
int main (int argc, char** argv)
{
  ...
  // Якщо аргумент оператора `sizeof` - це вираз, тоді його аргументи не оцінються
  ...
  // Масиви повинні бути проініціалізовані конкретним значенням.
  ...
  // масив в наступному рядку. Тому, наступне оголошення еквівалентне:
  char my_array[] = {0};
  ...
  // Індексація по масиву така ж сама, як і в іншим мовах програмування або,
  ...
  // константою під час часу компіляції:
  ...
  */
  ...
  // Щоб прочитати значення, яка зберігається за адресою, на яку вказує вказівник,
  ...
  // Будьте обережними із передачею значень, що надаються користувачем, в calloc!
  // Про всяк випадок, використовуйте calloc в таких ситуаціях (який, на відміну від 
  // calloc, також заповнює пам'ять нулями).
...
void str_reverse(char *str_in)
{
  ...
  size_t len = strlen(str_in); // `strlen()` це частина стандартної бібліотеки С
                               // Зауважте: довжина, яку поветає `strlen`, не включає
...
void str_reverse_through_pointer(char *str_in) {
  ...
  // f(str_in); // Це альтернативий, але теж вірний синтаксис виклику функції.
}
...
/* 
Заголовки можна додавати в інші заголовки, таком чином вони разом додаються
у подальшому.                      
*/
#include <string.h>
