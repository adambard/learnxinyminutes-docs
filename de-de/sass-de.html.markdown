...
/* Du kannst auch deine eigenen Funktionen definieren. Funktionen ähneln
   ...
   daran das mixins am besten zur Generierung von CSS eignen, während
...
Du kannst beide Syntaxen benutzen, gehe einfach in die Einstellungen und wähle entweder Sass oder SCSS.
