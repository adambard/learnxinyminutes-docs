...
으악 너무 못생겼어 | 그만 | 둬
---
추가 정보를 위해, 존 그루버의 공식 문법 [문서](http://daringfireball.net/projects/markdown/syntax)와 애덤 프릿차드의 훌륭한 [치트싯](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)을 확인하세요.