...
[ПОДРОБНЕЕ О ВИДЖЕТАХ](http://doc.qt.io/qt-5/qtwidgets-index.html)
...
[ПОДРОБНЕЕ О СЛОТАХ И СИГНАЛАХ](http://doc.qt.io/qt-4.8/signalsandslots.html)
...
class CounterLabel : public QLabel {
    Q_OBJECT  // макрос Qt, который должен присутствовать во всех созданных виджетах
...
[ДОКУМЕНТАЦИЯ](http://wiki.qt.io/Main/ru)
