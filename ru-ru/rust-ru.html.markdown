...
Первый релиз Rust, 0.1, вышел в Январе 2012, и в после течении 3 лет интенсивной разработки все пользователи были вынуждены использовать ночные сборки, пока не выпустили стабильную версию.
...
И хотя Rust низкоуровневый язык, но в него включены некоторые функциональный концепции ранее присущее в основном высокоуровневым языкам. Это сделало программы на Rust не только быстрыми, но и более простыми и эффективными в программировании.
