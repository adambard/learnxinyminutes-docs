...
<!-- Можно делать списки задач. Блок ниже создает HTML чекбоксы (флаг, переключатель). -->

Для отметки включенного чекбокса используйте 'x'
- [ ] Первая задача
- [ ] Вторая задача
Этот чекбокс ниже будет отмечен
...
<!-- В Github Flavored Markdown вы можете использовать тэг <kbd> для представления клавиш клавиатуры. -->
