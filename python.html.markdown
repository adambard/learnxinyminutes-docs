...
# You can declare sets (which are like unordered lists that cannot contain duplicated values) using the set object. Note: set is mutable; if you want immutability, use frozenset instead
empty_set = set()
